...
flags.DEFINE_string("save_path", "./model", "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("train_data", './data/text8', "Training text file. "
                    "E.g., unzipped file http://mattmahoney.net/dc/text8.zip.")
flags.DEFINE_string(
    "eval_data", "./data/test", "File consisting of analogies of four tokens."
